 ...
 */
#ifndef RTW_HEADER_PhysicalLayerModel_private_h_
#define RTW_HEADER_PhysicalLayerModel_private_h_
#include "rtwtypes.h"
...
#define rt_VALIDATE_MEMORY(S, ptr)     if(!(ptr)) {\
 rtmSetErrorStatus(PhysicalLayerModel_M, RT_MEMORY_ALLOCATION_ERROR);\
 }
#endif
...
/* Used by FromWorkspace Block: '<S3>/From Workspace' */
...
#endif                                 /* RTW_HEADER_PhysicalLayerModel_private_h_ */
