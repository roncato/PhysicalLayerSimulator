...
#include "PhysicalLayerModel_Statistics2.h"
...
void PhysicalLayerM_Statistics2_Init(DW_Statistics2_PhysicalLayerM_T *localDW)
{
  ...
  /* InitializeConditions for S-Function (scomerrrate2): '<S8>/Error Rate Calculation' */
  localDW->errors = 0.0;
  localDW->symbols = 0.0;
  localDW->STDelay = 0;
  localDW->curTx = 0;
  ...
  /* End of InitializeConditions for S-Function (scomerrrate2): '<S8>/Error Rate Calculation' */
}
...
{
  /* Start for SignalToWorkspace: '<S8>/Error Vars' */
  {
  ...
  /* Start for SignalToWorkspace: '<S8>/Rx2' */
  {
  ...
  /* Start for SignalToWorkspace: '<S8>/Tx2' */
  {
    int_T dimensions[2] = { 264, 1 };
  ...
  DW_Statistics2_PhysicalLayerM_T *localDW)
{
  ...
  /* S-Function (scomerrrate2): '<S8>/Error Rate Calculation' */
  err = 0.0;
  sym = 0.0;
  ratio = 0.0;
